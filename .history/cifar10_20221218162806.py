...
def main():
    ...
    x_normal_test = x_normal_test[:990]
    x_abnormal_test = x_abnormal_test[:10]

    x_mixed_train = np.concatenate((x_normal_train[:4950],x_abnormal_train[:50]))
    ...
    model, history = oc_nn.train_model(x_mixed_train, epochs=epochs, nu=nu, init_lr=0.000001)
